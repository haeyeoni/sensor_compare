...
public:
    CountPoints() {
        this->subscriber = this->nh.subscribe("/ce30_points", 10, &CountPoints::PointsInBounary, this);
    ...
    void PointsInBounary(const sensor_msgs::PointCloud &cloud_msg) {
        sensor_msgs::PointCloud2 cloud_msg2;
        sensor_msgs::convertPointCloudToPointCloud2(cloud_msg, cloud_msg2);
        ...
        points_out.header.frame_id = "ce30";
